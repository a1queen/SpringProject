...
public class TestCompanyController {
	...
	public void getAllCompanies_success() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/company").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isAccepted()).andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.hasSize(2)))
